...
class BronzeFragment : Fragment() {
    ...
    lateinit var talbatoffer: ImageView
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_bronze, container, false)
        image1 = view.findViewById(R.id.image1)
        talbatoffer = view.findViewById(R.id.talbatoffer)
        ...
        changeCode()
        talbatoffer.setOnClickListener {
                    ...
                    db.collection(Constants.SELLERS_COLLECTION)
                        ...
                        .addOnCompleteListener { task ->
                            if (task.isSuccessful && task.result != null) {
                                ...
                                if (pointsValue != null && pointsValue >= 250) {
                                    isTalbatOfferChosen = true
                                    playHandAnimation()
                                    val newPointsValue = pointsValue - 250
                                    db.collection(Constants.SELLERS_COLLECTION)
                                        .document(id!!)
